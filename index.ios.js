...
export default class DoubanMovies extends Component {
  constructor(props){
    ...
    this.state = {
      ds: ds.cloneWithRows(data["subjects"])
    } 
  }
...
AppRegistry.registerComponent('DoubanMovies', () => DoubanMovies);
